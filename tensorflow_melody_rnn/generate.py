...
'../dataset/processed/classical/bach_850_format0.mid-f3ae883fc3c0e54dc5a7378740db5995.data',
...
def main(_):
    ...
    outputs = model.sample(1000, prime =events[0:100], vocab_size=EventSeq.dim())
